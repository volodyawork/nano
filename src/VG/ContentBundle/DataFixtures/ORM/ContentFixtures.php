...
class ContentFixtures implements FixtureInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $article1->setContent('<p>С каждым днем становится все больше людей, которых волнует вопрос энергосбережения,
        ...
        for ($i=1; $i<=30; $i++){
            $article2 = new Article();
            $article2->setName($i . 'Весь модельный ряд светодиодных экранов Absen теперь доступен по прямым ценам завода');
            $article2->setSlug($i . 'ves_modelniy_ryad');
            $article2->setContent($i . 'Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. Здесь полное описание первой новости. ');
            $article2->setStatus(1);// опубликовано, доступно для просмотра
